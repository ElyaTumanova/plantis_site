	...
	<main id="main" class="site-main" role="main">
		...
		<div class="about">
            <div class="about__wrap">
                <div class="info__wrap">
                    ...
                    <div class="info__paragraph">
                        ...
                        <ul>
                            ...
                            <li>Вам не нужно ждать, потому что у нас есть доставка “День в день”. А при заказе от <?php echo $min_free_delivery ?> рублей, мы доставим нового друга бесплатно;</li>
                ...
                <div class="info__wrap">
                    <div class="about__photo nivo-about-photo-gallery">
