...
<div  class="faq-items">
  <div class="faq-col">
    <div class="faq-item">
      <div class="faq-question icon icon--plus">
        <h3 class="h5">Как использовать подарочный сертификат?</h3>
      </div>
    ...
    <div class="faq-item">
      <div class="faq-question icon icon--plus">
        <h3 class="h5">Не получается применить — что делать?</h3>
      </div>
      <div class="faq-answer">
        <p>
    ...
    <div class="faq-item">
      <div class="faq-question icon icon--plus">
        <h3 class="h5">Сколько сертификатов можно применить в одном заказе?</h3>
      </div>
      <div class="faq-answer">
        <p>
  ...
  <div class="faq-col">
    ...
    <div class="faq-item">
      <div class="faq-question icon icon--plus">
        <h3 class="h5">Как проверить баланс?</h3>
      </div>
      <div class="faq-answer">
        <p>
          Проверьте баланс сертификата
    ...
    <div class="faq-item">
      <div class="faq-question icon icon--plus">
        <h3 class="h5">На что можно потратить?</h3>
      </div>
      <div class="faq-answer">
        <p>
