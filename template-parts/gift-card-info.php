...
<div class="giftcard-advantages">
  ...
  <div class="giftcard-advantages__wrap">
    ...
    <!-- <div class="giftcard-advantages__title">Бесплатная пересадка</div> -->
    <div class="giftcard-advantages__descr">Гибкий номинал сертификата от 3000 до 100 000 рублей</div>		
  </div>
  <div class="giftcard-advantages__wrap">									
    ...
    <!-- <div class="giftcard-advantages__title">Бережная доставка</div> -->
  ...
  <div class="giftcard-advantages__wrap">		
    ...
    <!-- <div class="giftcard-advantages__title">Бесплатная консультация</div> -->
  ...
  <div class="giftcard-advantages__wrap">		
    <img width="112" height="100" src="https://plantis.shop/wp-content/uploads/2023/11/уход_зел.svg" class="giftcard-advantages__image" alt="" loading="lazy">												
    <!-- <div class="giftcard-advantages__title">Бесплатная консультация</div> -->
    <div class="giftcard-advantages__descr">Можно отправить получателю сразу или выбрать дату</div>
  </div>	
</div>