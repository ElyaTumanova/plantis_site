			...
			<div class="header__info">
				<div class="header__info-wrap container">
					<nav class="header__info-navigation" role="navigation">
                        <ul class="menu menu--info menu-horizontal"><li id="menu-item-51941" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51941 menu-node menu-node_lvl_1"><a href="<?php get_site_url()?>/about-us/" class="menu-link">О нас</a></li>
                            <li id="menu-item-51944" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-51944 menu-node menu-node_lvl_1"><a href="#" class="menu-link">Доставка и самовывоз</a>
                                <ul class="sub-menu menu menu--dropdown menu--vertical menu--dropdown_lvl_1">
                                    <li id="menu-item-51942" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51942 menu-node menu-node_lvl_2"><a href="<?php get_site_url()?>/delivery/" class="menu-link">Доставка и самовывоз (Москва и МО)</a></li>
                                    <li id="menu-item-51943" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51943 menu-node menu-node_lvl_2"><a href="<?php get_site_url()?>/dostavka-komnatnyh-rastenij-po-rossii/" class="menu-link">Доставка по России</a></li>
                                </ul>
                            </li>
                            <li id="menu-item-51946" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51946 menu-node menu-node_lvl_1"><a href="<?php get_site_url()?>/payment/" class="menu-link">Способы оплаты</a></li>
                            <li id="menu-item-51945" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51945 menu-node menu-node_lvl_1"><a href="<?php get_site_url()?>/contacts/" class="menu-link">Контакты</a></li>
                            <li id="menu-item-51947" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-51947 menu-node menu-node_lvl_1"><a href="#" class="menu-link">Инфо</a>
                                <ul class="sub-menu menu menu--dropdown menu--vertical menu--dropdown_lvl_1">
                                    <li id="menu-item-51949" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51949 menu-node menu-node_lvl_2"><a href="<?php get_site_url()?>/refund_returns/" class="menu-link">Возврат и обмен</a></li>
                                    <li id="menu-item-51950" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51950 menu-node menu-node_lvl_2"><a href="<?php get_site_url()?>/faq/" class="menu-link">Вопросы и ответы</a></li>
                                    <li id="menu-item-51951" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51951 menu-node menu-node_lvl_2"><a href="<?php get_site_url()?>/partners/" class="menu-link">Поставщикам и партнерам</a></li>
                                    <li id="menu-item-51948" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-51948 menu-node menu-node_lvl_2"><a href="<?php get_site_url()?>/vakansii/" class="menu-link">Вакансии</a></li>
                                </ul>
                            </li>
                        </ul>
					</nav>
