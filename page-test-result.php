...
<div class="result-test">
	...
	<div class="entry-content">
        ...
        <img class="test-image" src="<?php echo $plants_by_slug[$plant]['inage']?>" alt = "<?php echo $plants_by_slug[$plant]['name']?>">
        ...
        <div class="test-actions">
            ...
            <div class = "test-share">
                ...
                <div>
                    ...
                    <a class="social-media__button button social-media__button-whatsapp" href="https://web.whatsapp.com/send?text=Пройди тест - Какое ты растение? - <?php echo $test_link?>" data-action="share/whatsapp/share" target="_blank" rel="noopener" title="WhatsApp">
