            ...
            <td class="plnt_product-remove">
              <?php
                ...
                echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                  ...
                  sprintf(
                    '<a href="%1$s"
                      class="plnt_remove_from_cart_button"
                      aria-label="%2$s"
                      data-product_id="%3$s"
                      data-cart_item_key="%4$s"
                      data-product_sku="%5$s"
                      data-product_name="%6$s"
                      data-product_category="%7$s"
                      data-product_quantity="%8$s"
                      data-product_price="%9$s">
                        %10$s
                    </a>',
