...
<div class="woocommerce-shipping-totals shipping">
	<div class="woocommerce-shipping-totals__inner" data-title="<?php echo esc_attr( $package_name ); ?>">
		<div class="shipping__head">
      <h2 class="h3"><?php echo wp_kses_post( $package_name ); ?></h2>
				...
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						...
						printf(
							...
							$index,
							esc_attr( sanitize_title( $method->id ) ),
							plnt_wc_cart_totals_shipping_method_label( $method )
						);
