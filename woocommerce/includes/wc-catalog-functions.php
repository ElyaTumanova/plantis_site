...
function shop_only_instock_products( $meta_query, $query ) {
    ...
    global $treez_cat_id;
	if( is_shop() || is_product_category($gorshki_cat_id) || term_is_ancestor_of( $gorshki_cat_id, get_queried_object_id(), 'product_cat' ) || is_product_category($treez_cat_id) || is_search()) { 		//где хотим срыть товары не в наличии
		$meta_query[] = array(
			'key' => '_stock_status',
			'value' => 'outofstock',
			'compare' => '!='
