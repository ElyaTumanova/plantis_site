...
if ( defined( 'YITH_WCWL' ) && ! function_exists( 'yith_wcwl_get_items_count' ) ) {
  ...
  add_action( 'wp_ajax_yith_wcwl_update_wishlist_count', 'yith_wcwl_get_items_count' );
  add_action( 'wp_ajax_nopriv_yith_wcwl_update_wishlist_count', 'yith_wcwl_get_items_count' );
