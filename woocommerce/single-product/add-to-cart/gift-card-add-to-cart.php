...
<div class="gift_card_template_button variations_button">
	...
	<?php endif; ?>
	<button type="submit"
			class="single_add_to_cart_button ajax_add_to_cart  button alt"><?php echo esc_html( apply_filters( 'ywgc_add_to_cart_button_text', $product->single_add_to_cart_text() ) ); ?></button>
