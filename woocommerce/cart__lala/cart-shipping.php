			...
			<ul id="shipping_method" class="woocommerce-shipping-methods <?php if ( plnt_is_backorder() || plnt_is_treez_backorder()) : ?> woocommerce-shipping-backorder <?php endif;?>">
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						...
						printf( '<label for="shipping_method_%1$s_%2$s">%3$s</label>', $index, esc_attr( sanitize_title( $method->id ) ), plnt_wc_cart_totals_shipping_method_label( $method ) ); // WPCS: XSS ok.
