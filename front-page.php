	...
	<div class="main__wrap container main__row">
		<div class="advantages">
			...
			<div class="advantages__wrap">									
				...
				<div class="advantages__descr">Осуществляем доставку комнатных растений до двери. <?php if($min_free_delivery) {?> Если сумма покупки будет выше <?php echo $min_free_delivery?> рублей, то делаем это бесплатно</div>	<?php}?>
			</div>
			<div class="advantages__wrap">		
