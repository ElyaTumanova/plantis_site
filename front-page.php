...
<div class="content-area-full-width">
  ...
  <div class="container main__row main__promo">
    <div class="main__promo-card">
      <a href="<?php echo site_url()?>/test-kakoe-ty-rastenie" target="_blank"><img src="<?php echo get_template_directory_uri()?>/images/gift-card/test_main_cover.webp" alt="Пройди тест - Какое ты комнатное растение?"></a>
    </div>
    <div class="main__promo-card">
