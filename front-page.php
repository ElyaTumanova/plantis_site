...
<div class="content-area-full-width">
	...
	<div class="main__about container main__row">
		...
		<p class="main__about-text">В нашем каталоге представлены <strong>горшечные растения</strong>, которые подойдут как для уютной квартиры, так и для стильного офиса, ресторана, салона красоты или бизнес-центра. Мы работаем как с физическими, так и с юридическими лицами, предлагая выгодные условия для корпоративных клиентов.</p>
