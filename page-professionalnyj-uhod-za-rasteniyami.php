...
<div class="content-area">
    ...
    <div class="page-ukhod service-page">
      <div class="page-ukhod__first-screen">
        ...
        <img class="page-ukhod__photo" loading="lazy" src="<?php echo get_template_directory_uri()?>/images/landscaping.webp" alt="Профессиональный уход за растениями">               
        ...
        <button class="page-ukhod__rasschet button button--green page-popup-open-btn" name="Рассчитать стоимость с первого экрана">Рассчитать стоимость</button>
      ...
      <div class="page-ukhod__service-item">
        ...
        <button class="page-ukhod__service-item-order button button--green  page-popup-open-btn" name="Заказать стандартный тариф">Заказать</button>
      </div>
      ...
      <div class="page-ukhod__service-item">
        ...
        <button class="page-ukhod__service-item-order button button--green  page-popup-open-btn" name="Заказать гарантийное обслуживание">Заказать</button>
      </div>
      ...
      <div class="page-ukhod__service-item">
        ...
        <button class="page-ukhod__service-item-order button button--green  page-popup-open-btn" name="Заказать разовый выезд">Заказать</button>
      </div>
