      ...
      <section class="section page-ukhod__first-screen">
        <div class="page-ukhod__first-screen-wrap">
          <div class="page-ukhod__first-screen-inner">
            <h1 class="page-ukhod__entry-title h1">Профессиональный </br>уход за&nbsp;растениями</h1>
            <div class="page-ukhod__intro">
              Уход за растениями требует знаний и опыта. Попытка сэкономить, поручив его сотрудникам или клинингу, нередко приводит к гибели растений и дополнительным расходам на их замену.
            </div>
        ...
        <div class="page-ukhod__intro_small">
          <p>Если вы не хотите взваливать на свои плечи и плечи своих сотрудников дополнительную ответственность, то можно делегировать её нам!</p>
