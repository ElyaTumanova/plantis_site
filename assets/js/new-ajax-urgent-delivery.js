...
const noDeliveryDays = ['26.05'] //format dd.mm - дни когда нет доставки
...
class Checkout {
  ...
  constructor (rootElement) {
    ...
    //initial state
    this.deliveryDatesInputElements[0].checked = true;
    ...
    this.checkoutState = this.getCheckoutParametrs()
    this.state = this.getAjaxParametrs()
  ...
  //         this.setAjaxState()
  //         console.log('getProxyCheckoutState updateUI')
  //         this.updateUI()
  //       }
  //       return true
  //     },
...
hasStateChanges(oldState, newState) {
...
setCheckoutState() {
  ...
  // console.log('hi setCheckoutState')

  // console.log(this.checkoutState)
  // console.log(this.state)

  const checkoutState = this.getCheckoutParametrs()
  const initialAjaxState = this.state

  // console.log(checkoutState)

  if (!this.hasStateChanges(this.checkoutState, checkoutState)) {
    return
  }
  ...
  // updateUI мог снять checked
  this.checkoutState = this.getCheckoutParametrs()
  // console.log(this.checkoutState)

  const filnalAjaxState = this.getAjaxParametrs()

  // console.log(this.state)
  // console.log(filnalAjaxState)

  if (this.hasStateChanges(initialAjaxState, filnalAjaxState)) {
    this.state = filnalAjaxState
  ...
  getAjaxParametrs() {
    // console.log(this.checkoutState.deliveryInterval)
  ...
  unCheckFields(elements, isHidden) {
    ...
    // if (hasChanged) {
    //   console.log('unCheckFields hasChanged')
