...
<div class="content-area">
    ...
    <div class="test__disclaimer">
        <img class="test__cover" 
            ...
            srcset="
            <?php echo get_template_directory_uri() .'/images/test/test_cover_long.webp'?> 300w,
        ...
        <div class="test__disclaimer-text test__disclaimer-text_mob">
            <p><strong>Внимание! Тест имеет исключительно развлекательный характер. Его результат не обязывает вас пересаживаться или поливаться чаще.</strong></p>
            <p>Все совпадения с вашими чертами характера — случайны, но подозрительно точны.</p>
            <p><strong>С любовью, ваш зелёный ироничный внутренний сад!</strong></p>
        </div>
