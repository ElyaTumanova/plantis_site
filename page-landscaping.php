    ...
    <div class="page-lanscaping service-page">
      <div class="page-peresadka__first-screen">
        ...
        <div class="page-peresadka__buttons">
          <button class="page-peresadka__rasschet button--green button page-popup-open-btn" name="Заявка на озеленение">Оставить заявку</button>
      ...
      <div class="page-peresadka__service-item">
        ...
        <p class="page-peresadka__service-item-descr">Стоимость озеленения зависит от большего количества факторов - количества растений, высоты, материала кашпо и т.д. <br>Для вашего удобства мы выделили три условных тарифа, чтобы вам было проще ориентироваться:</p>
        <ul class="page-ukhod__advantages-item">
          <li>
            <p>Акцент</p> 
          ...
          <li>
              ...
              <p>2 - 3 напольных растений для кабинета руководителя или наполнение зелёными акцентами офиса площадью до 100&nbsp;кв.м.</p>
          </li>
          <li>
              <p>Экосистема</p> 
      ...
      <div class="page-peresadka__service-item">
        ...
        <p class="page-peresadka__service-item-descr">Чтобы растения всегда выглядели безупречно и оставались здоровыми, мы можем предложить вам постпродажное обслуживание. Посмотреть тарифы на обслуживание растений вы можете 
          <a href="<?php echo site_url()?>/professionalnyj-uhod-za-rasteniyami" target="_blank">здесь
