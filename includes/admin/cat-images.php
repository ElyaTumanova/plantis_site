...
// Front image для брендов
add_action( 'product_brand_add_form_fields', 'plnt_add_product_cat_front_image_field' );
add_action( 'product_brand_edit_form_fields', 'plnt_edit_product_cat_front_image_field' );
add_action( 'created_product_brand', 'plnt_save_product_cat_front_image' );
add_action( 'edited_product_brand', 'plnt_save_product_cat_front_image' );

// Catalog image для брендов
add_action( 'product_brand_add_form_fields', 'plnt_add_product_cat_catalog_image_field' );
add_action( 'product_brand_edit_form_fields', 'plnt_edit_product_cat_catalog_image_field' );
add_action( 'created_product_brand', 'plnt_save_product_cat_catalog_image' );
add_action( 'edited_product_brand', 'plnt_save_product_cat_catalog_image' );