...
function create_google_xml_btn () {
	?>
	<button class="xml_button xml_button_google">Создать фид для Гугла</button>
	<script>
        function create_google_xml(){
            <?php 
            ...
            foreach($allproducts as $allproduct){
                ...
                if ($sale>0) {
                    $google_xml .= "<g:sale_price>".get_post_meta($allproduct->ID,'_sale_price',true)." RUB</g:sale_price>
...
add_action( 'wp_footer', 'create_google_xml_btn' );
?>